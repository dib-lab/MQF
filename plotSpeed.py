...
mqf_res=prepare([inputFile[0],inputFile[1],inputFile[2]])
...
cqf_res=prepare([inputFile[3],inputFile[4],inputFile[5]])
...
bmqf_res=prepare([inputFile[6],inputFile[7],inputFile[8]])
...
CountminKhmer_res=prepare([inputFile[9],inputFile[10],inputFile[11]])
...
Countmin_res=prepare([inputFile[12],inputFile[13],inputFile[14]])
...
distributions = ['Zipfian Z=2', 'Zipfian Z=3', 'Zipfian Z=5','Kmers']
fig, ax = plt.subplots()
...
# make bar plots
mqf_fpr_0_0001_bar = plt.bar(mqf_bar_positions, mqf_res[0][2], bar_width-epsilon,
                          color=mqfColor,
                             edgecolor=mqfColor,
                             linewidth=line_width,
                             bottom=mqf_res[1][2],   
                          label='MQF FPR 0.0001')
mqf_fpr_0_001_bar = plt.bar(mqf_bar_positions, mqf_res[0][1], bar_width-epsilon,
                          bottom=mqf_res[1][1],
                          alpha=opacity,
                          color='white',
                          edgecolor=mqfColor,
                          ...
                          hatch='//',
                          label='MQF FPR 0.001')
mqf_fpr_0_01_bar = plt.bar(mqf_bar_positions, mqf_res[0][0], bar_width-epsilon,
                           bottom=mqf_res[1][0],
                           alpha=opacity,
                           color='white',
                           edgecolor=mqfColor,
...
cqf_fpr_0_0001_bar = plt.bar(cqf_bar_positions, cqf_res[0][2], bar_width- epsilon,
                             color=cqfColor,
                             bottom=cqf_res[1][2], 
                             linewidth=line_width,
                             edgecolor=cqfColor,
...
cqf_fpr_0_001_bar = plt.bar(cqf_bar_positions, cqf_res[0][1], bar_width-epsilon,
                          bottom=cqf_res[1][1], 
                          color="white",
                          hatch='//',
                          edgecolor=cqfColor,
                          ...
                          linewidth=line_width,
                          label='CQF FPR 0.001')
cqf_fpr_0_01_bar = plt.bar(cqf_bar_positions, cqf_res[0][0], bar_width-epsilon,
                           bottom=cqf_res[1][0],
                           color="white",
                           hatch='0',
                           edgecolor=cqfColor,
...
CountminKhmer_fpr_0_0001_bar = plt.bar(CountminKhmer_bar_positions, CountminKhmer_res[0][2], bar_width- epsilon,
                          color=CountminKhmerColor,
                          bottom=CountminKhmer_res[1][2],
                          edgecolor=CountminKhmerColor,
                          linewidth=line_width,
                          label='CountminKhmer FPR 0.0001')
CountminKhmer_fpr_0_001_bar = plt.bar(CountminKhmer_bar_positions, CountminKhmer_res[0][1], bar_width-epsilon,
...
CountminKhmer_fpr_0_01_bar = plt.bar(CountminKhmer_bar_positions, CountminKhmer_res[0][0], bar_width-epsilon,
...
bmqf_fpr_0_0001_bar = plt.bar(bmqf_bar_positions, bmqf_res[0][2], bar_width- epsilon,
                          bottom=bmqf_res[1][2],
                          color=bmqfColor,
                          edgecolor=bmqfColor,
                          linewidth=line_width,
                          label='Buffered MQF FPR 0.0001')
bmqf_fpr_0_001_bar = plt.bar(bmqf_bar_positions, bmqf_res[0][1], bar_width-epsilon,
                          bottom=bmqf_res[1][1],
                          alpha=opacity,
                          color='white',
                          edgecolor=bmqfColor,
...
bmqf_fpr_0_01_bar = plt.bar(bmqf_bar_positions, bmqf_res[0][0], bar_width-epsilon,
                           bottom=bmqf_res[1][0],
                           alpha=opacity,
                           color='white',
                           edgecolor=bmqfColor,
...
Countmin_fpr_0_0001_bar = plt.bar(Countmin_bar_positions, Countmin_res[0][2], bar_width- epsilon,
                          color=CountminColor,
                          bottom=Countmin_res[1][2],
                          edgecolor=CountminColor,
                          linewidth=line_width,
                          label='CountminKhmer FPR 0.0001')
Countmin_fpr_0_001_bar = plt.bar(Countmin_bar_positions, Countmin_res[0][1], bar_width-epsilon,
                          ...
                          hatch='//',
                          label='CountminKhmer FPR 0.001')
Countmin_fpr_0_01_bar = plt.bar(Countmin_bar_positions, Countmin_res[0][0], bar_width-epsilon,
