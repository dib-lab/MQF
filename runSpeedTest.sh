...
parallel --gnu -j1 './speedPerformance -s 28 -d kmers -k ERR1050075.fastq -f {1} > res/speed.kmers.s28.f{1}.{2} 2> speed.kmers.s28.f{1}.{2}.log ' ::: 0.0001  0.001 0.01 ::: 1 2 3
parallel --gnu -j1 './speedPerformance -z {2} -s 28  -f {1}  > res/speed.z{2}.s28.f{1}.{3} 2> speed.z{2}.s28.f{1}.{3}.log' :::  0.0001 0.001 0.01 ::: 2 3 5 ::: 1 2 3 
